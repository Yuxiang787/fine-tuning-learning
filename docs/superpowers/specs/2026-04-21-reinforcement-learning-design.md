...
**Date:** 2026-04-21  
**Status:** Approved  
**Scope:** New standalone folder `04-强化学习/` added to the fine-tuning-learning teaching repo
...
**`01-RL基础概念.md`** — Reward, policy, value function, KL divergence penalty explained in plain language with diagrams.
...
**`03-算法对比.md`** — Comparison table: PPO vs DPO vs GRPO across axes of complexity, data requirements, stability, compute cost, and use cases.
...
- **Documentation**: Chinese (README files, docs/)
...
1. **01-基础概念** — understand the RL problem formulation for LLMs without writing a training loop
